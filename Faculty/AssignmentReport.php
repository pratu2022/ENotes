...
<!-- </div> -->
<div class="col-md-6">
    <input type="text" name="From" id="From" class="form-control  mt-2" placeholder="From Date"/>
</div>
<div class="col-md-4">
    <input type="text" name="to" id="to" class="form-control ml-3 mt-2" placeholder="To Date"/>
</div>
<div class="col-md-2">
    <input type="button" name="range" id="range" value="Get Report" class="button ml-5 mt-2"/>
</div>
</div>
<hr class="mt-3">
<div class="container">
...
<?php
include("../connect.php");
$query = "SELECT * FROM tbluploadassign";
