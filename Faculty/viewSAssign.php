...
<body>
    ...
    <div id="content">
        <div class="container ">
        <h1 class="display-6">Student's Assignment</h1>
        <hr class="mt-3">
            <div class="row">
                <div class="col-md-12">
                <div class="row">
                        ...
                        $qs = "SELECT Subject FROM tbluploadassign WHERE subject = '$row[subject_name]' ORDER BY Subject";
                        ...
                        <form action="viewStudAssign.php" method="post">
