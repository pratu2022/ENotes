            ...
            if (file_exists("uploadf/" . $_FILES['fac_image']['name']))
             {
                ...
                $query = "INSERT INTO `tblfaculty`(`id`, `regno`, `fac_name`, `fac_phone`, `fac_email`, `fac_address`, `fac_username`, `fac_password`, `fac_gender`, `fac_image`,`date`) VALUES (null,'$regno','$fac_name','$fac_phone','$fac_email','$fac_add','$fac_username','$password','$fac_gender','$fac_image',Now())";
