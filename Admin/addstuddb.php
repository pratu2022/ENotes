        ...
        if (!in_array($file_extension, $allowed_extension)) {
         ...
         else 
         {
            ...
            else 
            {
                ...
                $query = "INSERT INTO `tblstudent`(`id`, `regno`, `stud_name`, `stud_phone`, `stud_email`, `stud_address`,`stud_username`,`stud_password` ,`stud_gender`, `stud_image`,`date`) VALUES (null,'$regno','$stud_name','$stud_phone','$stud_email','$stud_add','$stud_username','$password','$stud_gender','$stud_image',Now())";
