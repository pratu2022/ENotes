   ...
   <div class="container">
        ...
        <?php
            ...
            if(isset($_POST['view']))
            {
                ...
                $query = "SELECT * FROM tblnotes WHERE Subject = '$subname' AND srno = '$id'";
                      ...
                      $pd = "../Faculty/uploadnotes/" . $row['Notes'];
                        if($row['Type'] == 'pdf' || $row['Type'] == 'docx')
                        {
                           if($row['Type'] == 'pdf'){
                            ...
                            <div class="card-body">
                            <div class="row"> -->
                            <embed src="<?php echo "../Faculty/uploadnotes/" . $row['Notes'] ?>" type="application/pdf" width=700 height=700  frameborder="0" /></br>
                            <a href="<?php echo "../Faculty/uploadnotes/" . $row['Notes'] ?>" class="button mt-2 mb-3 ml-3" download>Download</a> <span><a href="viewNotes.php" class="button mt-2">Back</a></span></span>
                            <?php
                           }
                           else
                           {
